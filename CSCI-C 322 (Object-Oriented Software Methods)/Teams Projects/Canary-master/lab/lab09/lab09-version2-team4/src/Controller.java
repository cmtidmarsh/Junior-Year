...
public class Controller implements Observer {
    ...
    public ArrayList<String> numStrArrayList = new ArrayList<>();
    private String lastO = "+";
    private String o = "";

    public Controller() throws RemoteException {
        try{
            Remote r = Naming.lookup("//localhost/BinaryCal");
            model = (CalculatorInterface) r;
        }
        catch(Exception e){
            e.printStackTrace();
        }
    ...
    private void operate(String currentO) throws RemoteException {
